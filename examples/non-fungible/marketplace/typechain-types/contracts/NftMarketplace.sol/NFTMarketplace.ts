...
export interface NFTMarketplace extends BaseContract {
  ...
  createAndListToken: TypedContractMethod<
    [tokenURI: string, price: BigNumberish],
    [bigint],
    "payable"
  >;

  createToken: TypedContractMethod<[tokenURI: string], [bigint], "payable">;
  ...
  getFunction(
    nameOrSignature: "createAndListToken"
  ): TypedContractMethod<
    [tokenURI: string, price: BigNumberish],
    [bigint],
    "payable"
  ...
  ): TypedContractMethod<[tokenURI: string], [bigint], "payable">;
  getFunction(
