...
export declare namespace NFTMarketplaceOld {
...
export interface NFTMarketplaceOldInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface NFTMarketplaceOld extends BaseContract {
  connect(runner?: ContractRunner | null): NFTMarketplaceOld;
  waitForDeployment(): Promise<this>;

  interface: NFTMarketplaceOldInterface;
  ...
  getAllNFTs: TypedContractMethod<
    [],
    [NFTMarketplaceOld.ListedTokenStructOutput[]],
    "view"
  >;
